...
namespace AdminCore.Migrations
{
    public class DbContextFactory : IDesignTimeDbContextFactory<MigrationsContext>
    {
        ...
        public MigrationsContext CreateDbContext(string[] args)
        {
            ...
            builder.UseSqlServer(@"Server=(localdb)\mssqllocaldb;Database=LEC-DB;Trusted_Connection=True;", optionsBuilder => optionsBuilder.MigrationsAssembly(typeof(MigrationsContext).GetTypeInfo().Assembly.GetName().Name));
